%% PRACTICE 8.2. Automatic localization of the dominant frequency in the periodogram
...
[Pmax, index]=max(Periodogram_normalized); %  Returns the maximum value and its index in the vector.
Fmax = f (index); % Look up that index in the frequency vector.
